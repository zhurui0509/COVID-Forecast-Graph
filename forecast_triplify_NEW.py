...
def main_groundTruth(initial_date, output_dir):
    ...
    output_inc_death = output_dir+ '/groundtruth_inc_death_'+initial_date+'.ttl'
    ...
    output_inc_case = output_dir+ '/groundtruth_inc_case_'+initial_date+'.ttl'
    ...
    output_cum_death = output_dir+ '/groundtruth_cum_death_'+initial_date+'.ttl'
    ...
    output_cum_case = output_dir+ '/groundtruth_cum_case_'+initial_date+'.ttl'
...
def main():
    ...
    ### Triplify the time 
    rdfType_time(target_dates_list, 'covid-instant', covid_instant, '../'+arg_out+'/timeInstant.ttl')
    ### Triplify the research_forecast
    research2forecast(research_forecast_list, '../'+arg_out+'/research2forecast.ttl')

    main_groundTruth(arg_time)  ## 2020-09-03
...
if __name__ == "__main__":
    ...
    print('aaaa')
    main_groundTruth("2020-12-01", '../OW_GT')  ## To fix the 4-digit county FIPS issue for OW demo
